...
class TestData(unittest.TestCase):
    def test_get_huggingface_data(self):
        ...
        loader = get_huggingface_data(dataset_path, dataset_subset, batch_size)

        # Assert that the train_loader and test_loader are instances of torch.utils.data.DataLoader
        self.assertIsInstance(loader, torch.utils.data.DataLoader)

        # Assert that the train_loader and test_loader have the expected batch sizes
        self.assertEqual(len(loader.batch_sampler), batch_size)
